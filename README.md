...
skills/skill/知识库/       # 原始 48 个兼容基线 + 持续扩展专题（当前 60 个）
...
- 比赛向第二轮吸收多个公开 Agent Skill 项目的增量思路，新增 gRPC、Shadow API、Next.js/SSR、Kubernetes、CI/CD、候选漏洞证据闸门和 Agent Skill 供应链审查。
